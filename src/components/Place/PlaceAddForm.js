...
import '../../App.css';
import { Form, Input, Tooltip, Icon, Select, Button, DatePicker, InputNumber } from 'antd';
    ...
    return (
      <Form {...formItemLayout} onSubmit={handleSubmit}>
        ...
        <Form.Item label="Eilių kiekis">
         ...
         initialValue: 8, rules: [{ required: true, message: 'Prašome įvesti eilių kiekį!' }],
        ...
        <Form.Item label="Vietų kiekis">
         ...
         initialValue: 20, rules: [{ required: true, message: 'Prašome įvesti vietų kiekį!' }],
          })(
